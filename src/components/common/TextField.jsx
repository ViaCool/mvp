...
import viBlack from '../../images/visibility_black_24dp 1.svg';
import gr from '../../images/Group 1.svg';
  ...
  return (
    <div>
      <div className="justify-between flex mb-1.5 items-center">
        <label htmlFor={id} className="text-neutral-750 block uppercase font-bold">
          {label}
        </label>
        {jsxLabel}
      </div>
      ...
      >
        ...
        />
        {variant === 'password' && (
          <button type="button" className="absolute top-3 right-4 z-10" onClick={togglePwd}>
            <img
              className="w-6 h-6"
              src={pwd ? {viBlack} : {gr}}
              alt=""
